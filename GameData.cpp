...
void GameData::loadGameData()
{
	...
	//player//
	//playerSpawnLevelOne = new sf::Vector2f(mGameData["level_1"]["wave_1"]["player_Start"]["x"].as<int>(),
	//	mGameData["level_1"]["wave_1"]["player_Start"]["y"].as<int>());
	///////
	...
	m_BulletDimensions = new sf::Vector2f(int(mGameData["level_1"]["wave_1"]["textures"]["enemy_bullet"]["w"].as<int>()),
		int(mGameData["level_1"]["wave_1"]["textures"]["enemy_bullet"]["h"].as<int>()));

	m_EnemyDimensions = new sf::Vector2f(int(mGameData["level_1"]["wave_1"]["textures"]["enemy_texture"]["w"].as<int>()),
		int(mGameData["level_1"]["wave_1"]["textures"]["enemy_texture"]["h"].as<int>()));

	m_PlayerDimensions = new sf::Vector2f(int(mGameData["level_1"]["wave_1"]["textures"]["player_texture"]["w"].as<int>()),
		int(mGameData["level_1"]["wave_1"]["textures"]["player_texture"]["h"].as<int>()));
