	...
	while (w.pollEvent(eve))
	{
		...
		case SHOP_RUNNING:
		{
			...
			if (theShop->state() == 2)
			{
				...
				//	playerStats.at(1), playerStats.at(2), playerStats.at(3), playerStats.at(5), playerStats.at(6), gd);
			...
			if (theShop->state() == 3)
			{
				...
				//	playerStats.at(1), playerStats.at(2), playerStats.at(3), playerStats.at(5), playerStats.at(6), gd);
				//theShop->musicPlaying = false; //Tiger Steve Angelo
